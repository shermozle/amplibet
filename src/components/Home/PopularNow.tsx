...
const PopularNow: React.FC = () => {
  return <div className="mb-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
        {mockSports.slice(0, 7).map(sport => <Link key={sport.id} to={`/sport/${sport.id}`} className="bg-surface rounded-lg p-4 flex flex-col items-center justify-center hover:bg-raised transition-colors">
